...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame])
    {
        ...
        _emptyIndicator.backgroundColor = [UIColor blackColor];
        [self addSubview:_emptyIndicator];
        
        _filledIndicator = [[UIView alloc] initWithFrame:CGRectMake(self.bounds.size.width / 2 - 10, self.bounds.size.height / 2 - 10, 20, 20)];
        _filledIndicator.backgroundColor = [UIColor blackColor];
        _filledIndicator.layer.cornerRadius = 10;
